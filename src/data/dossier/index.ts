...
export const DOSSIER_BY_SLUG: Record<string, unknown> = {
  "scanner-pdf": scannerPdf, "ai-chatbot": aiChatbot, "intermittent-fasting": intermittentFasting, flashcards, translator, "run-tracking": runTracking, "voice-recorder": voiceRecorder, "resume-builder": resumeBuilder, "invoice-maker": invoiceMaker, sobriety, "qr-scanner": qrScanner, "mind-mapping": mindMapping, "wallpapers-widgets": wallpapersWidgets, "water-hydration": waterHydration,
