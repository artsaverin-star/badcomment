...
export const plusStrings = defineStrings({
  ru: {
    ...
    priceScope: "За все разборы и идеи сразу, а не за одну тему. Без подписки.",
  ...
  en: {
    ...
    priceScope: "For every breakdown and idea at once, not a single topic. No subscription.",
  ...
  de: {
    ...
    priceScope: "Für alle Analysen und Ideen auf einmal, nicht für ein einzelnes Thema. Kein Abo.",
  ...
  fr: {
    ...
    priceScope: "Pour tous les décryptages et toutes les idées d’un coup, pas pour un seul thème. Sans abonnement.",
  ...
  ja: {
    ...
    topicsWord: "本",
    ideasWord: "件",
    priceScope: "1つのテーマではなく、すべての分析とアイデアが対象です。サブスクリプションはありません。",
