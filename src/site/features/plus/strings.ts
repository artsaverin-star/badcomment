...
export const plusStrings = defineStrings({
  ru: {
    ...
    // What the one price covers (people asked: one topic or everything?). {topics}/{ideas} =
    // counted words; word forms one|few|many|other.
    planScope: "Все {topics} и {ideas}",
    topicsWord: "разбор|разбора|разборов|разбора",
    ideasWord: "идея|идеи|идей|идеи",
    priceScope: "За все разборы и идеи сразу — на сайте и в приложении inApp для iPhone. Не за одну тему, без подписки.",
  ...
  en: {
    ...
    planScope: "All {topics} and {ideas}",
    topicsWord: "breakdown|breakdowns|breakdowns|breakdowns",
    ideasWord: "idea|ideas|ideas|ideas",
    priceScope: "Every breakdown and idea at once — on the website and in the inApp iPhone app. Not a single topic, no subscription.",
  ...
  de: {
    ...
    planScope: "Alle {topics} und {ideas}",
    topicsWord: "Analyse|Analysen|Analysen|Analysen",
    ideasWord: "Idee|Ideen|Ideen|Ideen",
    priceScope: "Alle Analysen und Ideen auf einmal – auf der Website und in der iPhone-App inApp. Nicht für ein einzelnes Thema, kein Abo.",
  ...
  fr: {
    ...
    planScope: "Les {topics} et {ideas}",
    topicsWord: "décryptage|décryptages|décryptages|décryptages",
    ideasWord: "idée|idées|idées|idées",
    priceScope: "Tous les décryptages et toutes les idées d’un coup — sur le site et dans l’app iPhone inApp. Pas pour un seul thème, sans abonnement.",
  ...
  ja: {
    ...
    planScope: "全{topics}の分析と{ideas}のアイデア",
    topicsWord: "本",
    ideasWord: "件",
    priceScope: "1つのテーマではなく、すべての分析とアイデアが対象です。サイトでもiPhoneアプリ「inApp」でも使えます。サブスクリプションはありません。",
