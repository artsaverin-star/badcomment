...
// readable and locked; old pages and NicheDossier) and in the old review archive. Top to bottom:
...
export type CategoryPulseHeroProps = {
  /** Every need of the block, strongest first: categoryNeeds(data, id), or data.needs on the review hub. */
  ...
  /** Category names with each need, for a cross-category list (the old review hub). */
