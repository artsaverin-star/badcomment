      ...
      <section className="relative overflow-x-clip pb-3 pt-0 sm:pb-4">
          <div aria-hidden className="pointer-events-none absolute inset-0 z-0">
            {floats.map((src, i) => (
              ...
              <img
                ...
                src={src}
                alt=""
                className={`ld-float absolute rounded-[14px] opacity-60 shadow-[0_14px_34px_-12px_rgba(0,0,0,0.85)] sm:opacity-70 ${sizes[i % sizes.length]} ${positions[i]} hidden sm:block`}
          ...
          <div className="relative z-10 mx-auto max-w-3xl text-center">
            <h1 className="ld-fade text-display text-[var(--color-text-primary)] text-balance" style={{ animationDelay: "0.05s" }}>
              {ru ? "Найди боль, за решение которой уже платят" : "Find a pain people already pay to solve"}
            </h1>
