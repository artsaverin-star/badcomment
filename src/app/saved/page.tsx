...
export default async function SavedPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-[640px] px-4 py-14">
      ...
      <p className="mx-auto mt-3 max-w-[40ch] text-center text-callout text-[var(--color-text-secondary)]">{ru ? "Идеи, которые ты отметил ♥ в ленте." : "The ideas you hearted in the feed."}</p>
      <div className="mt-8">
