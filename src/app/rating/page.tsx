...
const NICHES_RAW = [
  { slug: "yoga", name: "Йога", nameEn: "Yoga", blurb: "65 приложений: где практика ведёт в человеческом темпе и встречает новичка, а где инструктор тараторит, база поз скудная и накрутка (10 из 65).", blurbEn: "65 apps: where the practice guides at a human pace and welcomes a beginner, and where the instructor rushes, the pose library is thin and reviews are juiced (10 of 65)." },
  { slug: "cosmetics-ingredient-checker", name: "Состав косметики", nameEn: "Cosmetic scanner", blurb: "18 приложений: где вердикт по составу обоснован и товар находится в базе, а где скан не узнаёт продукт, оценка без объяснения и накрутка.", blurbEn: "18 apps: where the ingredient verdict is well-grounded and your product is in the database, and where the scan fails to recognize it, the score has no reasoning and reviews are juiced." },
  { slug: "faith-prayer-bible", name: "Библия и молитва", nameEn: "Faith & prayer", blurb: "87 приложений: где текст Писания точен, план чтения ведёт, а озвучка не отвлекает, а где подменяют перевод, теряются заметки и накрутка.", blurbEn: "87 apps: where the scripture text is accurate, the reading plan carries you and the audio does not distract, and where the translation gets swapped, notes vanish and reviews are juiced." },
  { slug: "white-noise-sleep-sounds", name: "Белый шум", nameEn: "White noise", blurb: "66 приложений: где звук держит всю ночь и петля склеена без щелчка, а где глохнет через час, слышен стык и накрутка (4 из 66).", blurbEn: "66 apps: where the sound holds all night and the loop is seamless, and where it cuts out after an hour, the seam is audible and reviews are juiced (4 of 66)." },
  { slug: "ai-species-identifier", name: "Определитель видов", nameEn: "Species ID", blurb: "48 приложений: где определитель отвечает точно и стабильно, а где три ответа на одного жука, замок после первого снимка и накрутка (13 из 48 накручены).", blurbEn: "48 apps: where the identifier is accurate and consistent, and where one bug gets three answers, a paywall drops after the first scan and reviews are juiced (13 of 48 are fake)." },
  { slug: "tarot-reading", name: "Таро", nameEn: "Tarot", blurb: "36 приложений: где вытяжка честная, значения полные и перевёрнутые карты на месте, а где подписка тянет к платным экстрасенсам и накрутка.", blurbEn: "36 apps: where the draw is honest and card meanings are complete with reversals, and where the subscription pushes you to paid psychics and reviews are juiced." },
  { slug: "ai-homework-solver", name: "Решатель домашки", nameEn: "Homework solver", blurb: "48 приложений: где фото распознаётся, ответ верный и с разбором по шагам, а где ошибка в примере, голый ответ и накрутка (10 из 48 накручены).", blurbEn: "48 apps: where the photo reads, the answer is correct and shown step by step, and where the solution is wrong, the answer is bare and reviews are juiced (10 of 48 are fake)." },
  { slug: "ai-companion-roleplay", name: "ИИ-компаньон", nameEn: "AI companion", blurb: "41 приложение: где спутник помнит историю и держит характер, а где забывает вас, ломает роль и упирается в счётчик сообщений, плюс накрутка (10 из 41).", blurbEn: "41 apps: where the companion remembers your history and stays in character, and where it forgets you, breaks the persona and hits a message counter, plus juiced reviews (10 of 41)." },
  { slug: "guitar-tuner-learn", name: "Гитара", nameEn: "Guitar", blurb: "58 приложений: где телефон точно слышит струну, а обучение доводит до конца, а где тюнер врёт, курс бросает на полпути и накрутка.", blurbEn: "58 apps: where the phone hears the string accurately and the lessons see you through, and where the tuner is off, the course quits on you and reviews are juiced." },
  { slug: "ai-photo-restore", name: "Реставрация фото", nameEn: "Photo restore", blurb: "27 приложений: где старое фото оживает, а лицо остаётся собой, а где ИИ рисует чужого человека, лепит водяной знак и накрутка.", blurbEn: "27 apps: where the old photo comes back to life and the face stays itself, and where the AI paints a stranger, slaps on a watermark and reviews are juiced." },
