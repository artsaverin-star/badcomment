...
import { importOldFavoritesOnce, mergeLibrary } from "@/site/features/library/server";
...
// Response = the merged account copy (same shape as GET /api/site/library). The old site's
// bookmarks are imported first (a no-op after the first GET; see importOldFavoritesOnce).
