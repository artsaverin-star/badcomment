...
const DICT: Record<Locale, Dict> = {
  en: {
    ...
    market2: {
      title: "We turn hundreds of thousands of reviews into ready insights",
      ...
      evidenceTitle: (label) => `Reviews: “${label}”`,
      ...
      gapsCaption: "Shared across the whole segment — the more complaints, the higher.",
    },
    ...
    product: {
      ...
      needsHeading: "Top complaints",
      needsCaption: "Grouped by meaning from the reviews — the more complaints, the higher.",
  ...
  ru: {
    ...
    ideas: {
      ...
      desc: "Каждая идея выросла из реальных отзывов на работающие приложения. Люди сами пишут, что бесит, чего не хватает и за что готовы платить, а мы превращаем это в готовый продукт под уже существующий спрос. По каждой идее видно, что строить, для кого и как на этом заработать.",
    ...
    market2: {
      title: "Превращаем сотни тысяч отзывов в готовые выводы",
      ...
      evidenceTitle: (label) => `Отзывы: «${label}»`,
      ...
      gapsCaption: "Общее для всего сегмента — чем чаще жалуются, тем выше.",
    },
    ...
    product: {
      ...
      needsHeading: "Основные жалобы",
      needsCaption: "Сгруппировано по смыслу из отзывов — чем чаще жалуются, тем выше.",
