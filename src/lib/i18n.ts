...
const DICT: Record<Locale, Dict> = {
  en: {
    ...
    market2: {
      ...
      gapsHeading: "What people ask for across the apps",
    ...
    product: {
      ...
      needsHeading: "What people ask for in the reviews",
  ...
  ru: {
    ...
    market2: {
      ...
      gapsHeading: "Что люди просят во всех приложениях",
    ...
    product: {
      ...
      needsHeading: "Что люди просят в отзывах",
