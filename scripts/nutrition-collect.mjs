...
// /tmp/nutrition/src/<key>.json + /tmp/nutrition/collect-meta.json.
import gplayPkg from "google-play-scraper";
const gplay = gplayPkg.default || gplayPkg;
import fs from "node:fs";

const APPS = [
  { key: "myfitnesspal", pkg: "com.myfitnesspal.android" },
  { key: "yazio", pkg: "com.yazio.android" },
  { key: "fatsecret", pkg: "com.fatsecret.android" },
  { key: "loseit", pkg: "com.fitnow.loseit" },
  { key: "lifesum", pkg: "com.sillens.shapeupclub" },
  { key: "foodvisor", pkg: "io.foodvisor.foodvisor" },
  { key: "cronometer", pkg: "com.cronometer.android.gold" },
  { key: "mynetdiary", pkg: "com.fourtechnologies.mynetdiary.ad" },
  { key: "carbmanager", pkg: "com.wombatapps.carbmanager" },
  { key: "noom", pkg: "com.wsl.noom" },
];

const COUNTRIES = ["us", "gb", "in", "ca", "au"];
const LANGS = ["en", "es", "pt", "de", "fr", "it"];
const OUT = "/tmp/nutrition/src";
...
fs.writeFileSync("/tmp/nutrition/collect-meta.json", JSON.stringify(results, null, 2));
console.log("DONE");
